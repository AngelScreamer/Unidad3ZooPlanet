...
namespace ZooPlanet.Repositories
{
	public class EspeciesRepository : Repository<Especies>
	{
        ...
        public EspeciesRepository(animalesContext context):base(context)
        {
        ...
        public override bool Validate(Especies entidad)
        {
            ...
            {
                throw new Exception("Debe indicar el hábitat de la especie");
            }
            ...
            {
                throw new Exception("Ya existe una especie registrado con el mismo nombre");
            }
